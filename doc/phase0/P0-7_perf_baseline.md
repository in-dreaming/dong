...
> 上游：[`doc/roadmap.md`](../roadmap.md) Phase 0 P0-7
> 性能预算：[`doc/perf_budget.md`](../perf_budget.md)
>
> 状态：方案 v1 / 2026-04-17
...
已有：
- `dong/scripts/tools/auto_profile_loop.py` — sweep + trace 解析（见 `doc/summary/opt.md`）。
...
`dong_app` 已有部分支持（见 `doc/summary/opt.md`），缺的部分按需扩展（注入脚本动作）。
...
- [ ] `doc/perf_budget.md` § 6 测量工具与脚本表，把 `perf_baseline.py` 标 ✅
- [ ] `doc/summary/opt.md` 末尾追加"perf_baseline.py 用法"
