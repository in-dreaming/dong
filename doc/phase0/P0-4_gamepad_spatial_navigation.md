...
> 上游：[`doc/roadmap.md`](../roadmap.md) Phase 0 P0-4
...
- [ ] `doc/specific/html_css_dom_草案.md` 新增 `nav-*` `data-nav-*` 表格
- [ ] `doc/重要特性.md` 新增 § "Gamepad Spatial Navigation"
- [ ] `doc/positioning.md` § 4 三轨表格补充"两轨都支持 spatial nav"
