...
> 上游：[`doc/roadmap.md`](../roadmap.md) Phase 2 P2-9
...
| force_sync API | ✅ |
| 实验报告 `doc/perf/async_layout_report.md` | ✅ |
...
- [ ] `doc/重要特性.md` § "Async Layout / Shaping" 状态从"实验"改"默认"
- [ ] `doc/positioning.md` § 8 决策记录追加：`<日期> Async layout 默认开启`
- [ ] `doc/perf_budget.md` § 3.2 首屏阻塞实测刷新
