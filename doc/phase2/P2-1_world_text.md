...
> 上游：[`doc/roadmap.md`](../roadmap.md) Phase 2 P2-1
> 定位依据：[`doc/positioning.md`](../positioning.md) § 5.2 World Space UI primitives
...
| `dong.renderText()` Direct Draw | ✅，单 view 屏幕空间（[`doc/arch/arch_font.md`](../arch/arch_font.md) § 9） |
...
- [ ] `doc/重要特性.md` 新增 § "World Space Text"
- [ ] `doc/positioning.md` § 5.2 World Space primitives 表格 P2-1 行从"待做"改"已交付"
- [ ] `doc/perf_budget.md` § 3.5 S5 实测填入
- [ ] `dong/include/dong_world_text.h` 文档化
- [ ] `doc/integration_ue.md` / `integration_unity.md` 加 "World Text" 集成段
