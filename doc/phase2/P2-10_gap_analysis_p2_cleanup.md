...
> 上游：[`doc/roadmap.md`](../roadmap.md) Phase 2 P2-10
...
- [ ] `doc/specific/html_css_dom_gap_analysis.md` 大量条目状态从 ⚠️/❌ 改 ✅；明确不做的标"❌ Won't Do（理由）"
- [ ] `doc/specific/html_css_dom_草案.md` 同步
- [ ] `doc/重要特性.md` 多个章节扩充：RTL / Pointer / Animation / 容器查询 / ScrollSnap / a11y
- [ ] `doc/dong-extensions.md`（新建）集中列私有扩展
- [ ] `doc/positioning.md` § 6 能力边界表更新
