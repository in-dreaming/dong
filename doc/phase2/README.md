...
| **dong 私有扩展** | 必须 `dong-` / `--dong-` / `data-dong-` 前缀；进 `doc/dong-extensions.md` |
...
| [`doc/roadmap.md`](../roadmap.md) | Phase 2 概览来自此 |
| [`doc/perf_budget.md`](../perf_budget.md) | 验证规则的指标依据 |
| [`doc/phase0/README.md`](../phase0/README.md) | 前置 |
| [`doc/phase1/README.md`](../phase1/README.md) | 前置 |
| [`doc/arch/arch_font.md`](../arch/arch_font.md) | P2-4 Lottie/Rive 复用 Slug pipeline 的依据 |
| [`doc/ideal/frame.md`](../ideal/frame.md) | P2-5 dong-ui 灵感来源；任务完成后替换 |
| [`doc/specific/html_css_dom_gap_analysis.md`](../specific/html_css_dom_gap_analysis.md) | P2-10 来源 |
| [`doc/integration_ue.md`](../integration_ue.md) [`integration_unity.md`](../integration_unity.md) | World Space primitives + npm 包后宿主集成更顺；adapter 仍长期低优先级 |
