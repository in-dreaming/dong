...
> 上游：[`doc/roadmap.md`](../roadmap.md) Phase 2 P2-2
...
- [ ] `doc/重要特性.md` 新增 § "World Decal"
- [ ] `doc/positioning.md` § 5.2 P2-2 行从"待做"改"已交付"
- [ ] `doc/perf_budget.md` § 3.5 S5 实测填入
- [ ] `dong/include/dong_decal.h` 文档化
- [ ] `doc/integration_ue.md` / `integration_unity.md` 加 "Decal" 集成段
