...
> 上游：[`doc/roadmap.md`](../roadmap.md) Phase 1 P1-5
> 既有讨论：[`doc/specific/wip项.md`](../specific/wip项.md) § grid
>
> 状态：方案 v1 / 2026-04-17
...
- [ ] `doc/specific/html_css_dom_草案.md` § 3.3 grid 行从 ❌ 改 ✅（注明子集）
- [ ] `doc/specific/wip项.md` § grid 表格更新
- [ ] `doc/重要特性.md` 新增 § "CSS Grid 子集"
- [ ] `doc/roadmap.md` Phase 1 P1-5 状态 ✅
- [ ] `doc/perf_budget.md` 新增 grid layout 时间指标
