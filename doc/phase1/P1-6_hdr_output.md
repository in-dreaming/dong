...
> 上游：[`doc/roadmap.md`](../roadmap.md) Phase 1 P1-6
> 既有占位：[`doc/ideal/hdr.md`](../ideal/hdr.md)
>
> 状态：方案 v1 / 2026-04-17
...
| HDR 占位文档 | [`doc/ideal/hdr.md`](../ideal/hdr.md)（仅链接） |
...
- [ ] `doc/ideal/hdr.md` 替换为正式实现说明
- [ ] `doc/specific/html_css_dom_草案.md` § 3.6 / § 3.16 oklch / display-p3 状态
- [ ] `doc/重要特性.md` 新增 § "HDR 输出"
- [ ] `dong/include/dong.h` HDR ABI 文档化
- [ ] `doc/perf_budget.md` § 3 加 HDR 模式 GPU 时间对比
