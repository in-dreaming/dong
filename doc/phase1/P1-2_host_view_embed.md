...
> 上游：[`doc/roadmap.md`](../roadmap.md) Phase 1 P1-2
> 设计原案：[`doc/ideal/引擎适配.md`](../ideal/引擎适配.md) § 3.2 / § 5.3
...
- [ ] `doc/ideal/引擎适配.md` § 3.2 / § 5.3 状态从"草案"改"已实施"
- [ ] `doc/integration_ue.md` § 5 + `integration_unity.md` § 6 状态可对接
- [ ] `doc/重要特性.md` 新增 § "宿主嵌入 (`<host-view>`)"
- [ ] `doc/positioning.md` § 5.2 表格 EmbedSlot 行从"待做"改"已交付"
