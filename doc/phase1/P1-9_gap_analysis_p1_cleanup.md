...
> 上游：[`doc/roadmap.md`](../roadmap.md) Phase 1 P1-9
...
- [ ] `doc/specific/html_css_dom_gap_analysis.md` 本批次条目状态从 ⚠️/❌ 改为 ✅
- [ ] `doc/specific/html_css_dom_草案.md` 同步更新
- [ ] `doc/重要特性.md` 表单 / dialog / observer / fixed / 逻辑属性 / color-mix / light-dark 等章节扩充
- [ ] `doc/arch/react.md` § 4.4 / § 4.5 同步可用 API
