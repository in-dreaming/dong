...
> 上游：[`doc/roadmap.md`](../roadmap.md) Phase 1 P1-3
> 性能门槛：[`doc/perf_budget.md`](../perf_budget.md) § 3.6（DevTools 打开延迟）
>
> 状态：方案 v1 / 2026-04-17
...
- [ ] `doc/重要特性.md` 新增 § "DevTools (F12)"
- [ ] `doc/roadmap.md` Phase 1 P1-3 状态 ✅
- [ ] `doc/perf_budget.md` § 3.6 DevTools 打开延迟实测填入
