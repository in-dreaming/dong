...
set DONG_DEBUG_VIDEO_UPLOAD=1
set DONG_DEBUG_VIDEO_PAINT=1
rem 3d_screens_simple.exe > log2.log
rem dong_app.exe --html .\data\interative1.html
dong_app.exe --html .\data\video\video_play_test.html >log.log