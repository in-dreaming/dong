...
历史文档 `docs/developer/debug/font_msdf_aliasing.md` 里提到：
...
- `docs/developer/debug/font_msdf_aliasing.md`：历史上修过 distance_scale（msdf_scale 参与计算）与 range/可用区域问题。
- `docs/developer/debug/history_202601082006_summary.md`：提过 “MSDF 锯齿明显” 的通用方向（fwidth、最小 screenPxRange、超采样）。
