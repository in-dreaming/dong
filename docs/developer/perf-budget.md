...
>
> 与 [`docs/overview/positioning.md`](./positioning.md) 的能力边界、[`docs/roadmap.md`](./roadmap.md) 的阶段目标一一对应。
>
...
| 工具 | 用途 | 文档 |
|---|---|---|
| `dong/scripts/tools/auto_profile_loop.py` | 自动 build + run + 采样 trace | `docs/developer/optimization/profile-loop.md` |
| `dong/tmp/trace_summary.py` | 从 trace 中找 Top N 自耗时 scope | 同上 |
| `examples/html_render_test.cpp` | headless 多帧渲染 | `docs/architecture/overview.md` |
| `scripts/tools/run_baseline_compare.py` | 浏览器 baseline 像素 diff | `docs/architecture/overview.md` |
...
| 日期 | 变更 | 说明 |
|---|---|---|
| 2026-04-17 | v1 创建 | 基线指标主要来自 `docs/reference/features-index.md` § GPU 性能优化、`docs/developer/optimization/20260331.md`、`docs/architecture/render-pipeline.md`、`docs/developer/arch/text-rendering-spec.md`。S5 / S6 等 Phase 2/1 场景的指标为路线图目标，待实测后回填。 |
