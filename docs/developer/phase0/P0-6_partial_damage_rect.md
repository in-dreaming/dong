...
> 上游：[`docs/roadmap.md`](../roadmap.md) Phase 0 P0-6
> 性能门槛：[`docs/developer/perf-budget.md`](../perf_budget.md) § 3.2 / § 3.6
>
> 状态：方案 v1 / 2026-04-17
...
- [ ] `docs/developer/perf-budget.md` § 3.2 / § 3.6 当前实测列
- [ ] `docs/reference/features-index.md` 新增 § "增量重建（Damage Rect）"
- [ ] `docs/architecture/overview.md` 一帧数据流更新
