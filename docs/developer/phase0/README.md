...
新增 Phase 0 任务时，复用本结构；新增 Phase 1/2 任务时，分别建 `docs/developer/phase1/` `docs/developer/phase2/`。
...
| 文档 | 与本目录关系 |
|---|---|
| [`docs/overview/positioning.md`](../positioning.md) | 上位决策；本目录所有方案不得违背 |
| [`docs/roadmap.md`](../roadmap.md) | 三阶段总图；本目录 = Phase 0 详情 |
| [`docs/developer/perf-budget.md`](../perf_budget.md) | 验证规则的指标依据 |
| [`docs/architecture/render-pipeline.md`](../arch/render_pipeline.md) | P0-1 的设计原案 |
| [`docs/developer/arch/text-rendering-spec.md`](../arch/arch_font.md) | P0-3 mask 与 Slug 协调的依据 |
| [`docs/developer/arch/react-reconciler-spec.md`](../arch/react.md) | P0-8 react 生态对接清单的依据 |
| [`docs/developer/gap-analysis.md`](../specific/html_css_dom_gap_analysis.md) | P0-8 来源清单 |
| [`docs/reference/css-subset.md`](../specific/html_css_dom_草案.md) | 完成后状态需同步更新 |
| [`docs/reference/features-index.md`](../重要特性.md) | 完成后能力清单需同步更新 |
| [`docs/developer/optimization/profile-loop.md`](../summary/opt.md) | P0-7 工具链上位文档 |
| [`docs/architecture/overview.md`](../summary/architecture.md) | P0-6 完成后一帧数据流需更新 |
...
## 8. 实施进度（2026-05-04 更新）

| ID | 状态 | 完成项 | 剩余 |
|---|---|---|---|
| **P0-1** | ✅ Done | uber quad pipeline 全量落地 | — |
| **P0-2** | ✅ Done | CSS border-image 解析 ✅ · DrawNineSlice display item ✅ · nineslice_fs shader ✅ · 单 draw call pipeline ✅ | — |
