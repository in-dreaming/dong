...
> 上游：[`docs/roadmap.md`](../roadmap.md) Phase 0 P0-5
>
> 状态：方案 v1 / 2026-04-17
...
每个 release 必跑一遍，结果记录到 `docs/developer/qa-log.md`（新建）。
...
- [ ] `docs/developer/gap-analysis.md` § 4.5 三件套事件标 ✅
- [ ] `docs/reference/css-subset.md` § 4.4 `CompositionEvent` 标 ✅
- [ ] `docs/reference/features-index.md` 新增 § "IME 输入"
- [ ] `docs/developer/qa-log.md`（新建）记录每次 release 的多平台 IME 手动测试结果
