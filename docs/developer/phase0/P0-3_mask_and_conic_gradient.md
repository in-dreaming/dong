...
> 上游：[`docs/roadmap.md`](../roadmap.md) Phase 0 P0-3
>
> 状态：方案 v1 / 2026-04-17
...
- `conic-gradient`：[`docs/reference/css-subset.md`](../specific/html_css_dom_草案.md) § 3.7 标"⚠️可演进"，**未实现**。
...
verify:
  hard:
    ...
    - id: p0_3_zig_build
      cmd: "zig build"
      cwd: "dong/.worktrees/P0-3/dong"
      timeout_sec: 600
  soft:
    - id: p0_3_notes_ready_marker
...
- [ ] `docs/reference/css-subset.md` § 3.7 / § 3.16 更新 `conic-gradient` `mask` 状态
- [ ] `docs/reference/features-index.md` 新增 § "Mask + Conic Gradient（圆形 CD/血条）"
- [ ] `docs/developer/perf-budget.md` § 3.1 / § 3.2 更新（mask 离屏 RT 内存）
