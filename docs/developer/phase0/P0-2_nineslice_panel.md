...
> 上游：[`docs/roadmap.md`](../roadmap.md) Phase 0 P0-2
...
- `docs/reference/css-subset.md` 标 `border-image` 未列入支持。
...
- [ ] `docs/reference/css-subset.md` § 3.1 把 `border-image` 标 ✅
- [ ] `docs/reference/features-index.md` 新增 § "9-slice Panel" 段
- [ ] `docs/developer/perf-budget.md` § 4 atlas 估算更新
