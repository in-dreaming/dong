...
> 上游：[`docs/roadmap.md`](../roadmap.md) Phase 0 P0-1
> 设计原案：[`docs/architecture/render-pipeline.md`](../arch/render_pipeline.md)
...
- [ ] `docs/developer/perf-budget.md` § 3.1 当前实测列
- [ ] `docs/reference/features-index.md` § GPU 性能优化
- [ ] `docs/architecture/render-pipeline.md` 末尾追加"已实施 / 实测数据"
- [ ] `docs/overview/positioning.md` § 8 决策记录追加"Uber Quad 已默认开启"
