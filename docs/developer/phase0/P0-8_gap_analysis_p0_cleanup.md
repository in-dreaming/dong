...
> 上游：[`docs/roadmap.md`](../roadmap.md) Phase 0 P0-8
...
`gap_analysis.md` 列了大量 P0/P1 web 标准缺口。Ultralight 路线下，按 [`docs/overview/positioning.md`](../positioning.md) § 2 的标准重新筛选，把**"游戏 UI / React 生态强依赖、不补会偶发劝退用户"**的子集一次性补齐。
...
- [ ] `docs/developer/gap-analysis.md` 把本批次条目状态从 ⚠️/❌ 改为 ✅
- [ ] `docs/reference/css-subset.md` 同步状态
- [ ] `docs/reference/features-index.md` 章节"DOM API"扩充
- [ ] `docs/developer/arch/react-reconciler-spec.md` § 4.4 "DOM binding 差距"清掉已补条目
