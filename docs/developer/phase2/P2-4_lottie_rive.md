...
> 上游：[`docs/roadmap.md`](../roadmap.md) Phase 2 P2-4
>
> 状态：方案 v1 / 2026-04-17
...
| 项 | 现状 |
|---|---|
| Slug 贝塞尔曲线 GPU 管线 | ✅，[`docs/developer/arch/text-rendering-spec.md`](../arch/arch_font.md) § 2.3 |
| 矢量图标 / SVG | ❌（[`docs/reference/css-subset.md`](../specific/html_css_dom_草案.md) § 2.7 仅基础形状） |
| Lottie 支持 | ❌ |
| Rive 支持 | ❌ |
...
- [ ] `docs/reference/css-subset.md` § 2.7 / § 2.5 表格新增 `<dong-lottie>` `<dong-rive>` 行
- [ ] `docs/reference/features-index.md` 新增 § "Lottie / Rive 矢量动画"
- [ ] `dong/include/dong_vector.h` 文档化
- [ ] `docs/guide/integrations/unreal-engine.md` / `integration_unity.md` 加 "Lottie / Rive" 集成段
- [ ] `docs/developer/perf-budget.md` 新增 vector animation 场景
