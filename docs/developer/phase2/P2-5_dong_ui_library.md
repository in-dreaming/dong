...
> 上游：[`docs/roadmap.md`](../roadmap.md) Phase 2 P2-5
> 灵感：[`docs/developer/design/frame.md`](../ideal/frame.md)（mui/base-ui）
>
> 状态：方案 v1 / 2026-04-17
...
- `docs/developer/design/frame.md` 仅提到 base-ui 链接。
- 没有官方 npm 包。
...
- [ ] `docs/reference/features-index.md` 新增 § "dong-ui 组件库"
- [ ] `docs/overview/positioning.md` § 5.2 P2-5 行从"待做"改"已交付"
- [ ] `docs/developer/design/frame.md` 替换为正式 dong-ui 介绍
