...
| [`docs/roadmap.md`](../roadmap.md) | Phase 1 概览来自此 |
| [`docs/developer/perf-budget.md`](../perf_budget.md) | 验证规则的指标依据 |
| [`docs/developer/phase0/README.md`](../phase0/README.md) | 多数 Phase 1 任务是 Phase 0 的延续 / 进阶 |
| [`docs/developer/design/引擎适配.md`](../ideal/引擎适配.md) | P1-1 / P1-2 的设计原案 |
| [`docs/developer/design/hdr.md`](../ideal/hdr.md) | P1-6 占位文档；本任务完成后替换 |
| [`docs/developer/arch/react-reconciler-spec.md`](../arch/react.md) | P1-7 / P1-9 React 生态依据 |
| [`docs/developer/arch/text-rendering-spec.md`](../arch/arch_font.md) | P1-8 shaping 异步的依据 |
| [`docs/developer/gap-analysis.md`](../specific/html_css_dom_gap_analysis.md) | P1-9 来源清单 |
| [`docs/guide/integrations/unreal-engine.md`](../integration_ue.md) [`integration_unity.md`](../integration_unity.md) | P1-1 / P1-2 完成后状态可对接（adapter 仍低优先级） |
