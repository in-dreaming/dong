...
> 上游：[`docs/roadmap.md`](../roadmap.md) Phase 1 P1-4
> 性能门槛：[`docs/developer/perf-budget.md`](../perf_budget.md) § 3.2（live reload 端到端）
>
> 状态：方案 v1 / 2026-04-17
...
- [ ] `docs/reference/features-index.md` 新增 § "Live Reload"
- [ ] `docs/roadmap.md` Phase 1 P1-4 状态 ✅
- [ ] `docs/developer/perf-budget.md` § 3.2 live reload 实测填入
