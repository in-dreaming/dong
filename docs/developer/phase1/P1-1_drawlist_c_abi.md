...
> 上游：[`docs/roadmap.md`](../roadmap.md) Phase 1 P1-1
> 设计原案：[`docs/developer/design/引擎适配.md`](../ideal/引擎适配.md)（路线 A）
>
> 状态：方案 v1 / 2026-04-17
...
- [ ] `docs/developer/design/引擎适配.md` 第 5 章追加"已实施"段
- [ ] `docs/guide/integrations/unreal-engine.md` § 4.2 / 4.3 状态从"草案"改为"可对接"
- [ ] `docs/guide/integrations/unity.md` 同上
- [ ] `docs/reference/features-index.md` 新增 § "DongDrawList 公共 ABI"
- [ ] `docs/overview/positioning.md` § 5.2 表格 `DongDrawList` 行从"待做"改"已交付"
- [ ] `docs/developer/perf-budget.md` 新增"DrawList emit 时间"指标条目
