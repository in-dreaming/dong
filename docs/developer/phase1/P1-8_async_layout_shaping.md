...
> 上游：[`docs/roadmap.md`](../roadmap.md) Phase 1 P1-8
> 性能门槛：[`docs/developer/perf-budget.md`](../perf_budget.md) § 3.2（首屏阻塞 < 50 ms）
>
...
| 缓存 | TextShaper 有 static cache（[`docs/developer/arch/text-rendering-spec.md`](../arch/arch_font.md) § 9） |
...
- ShapeResult 直接写入 TextShaper static cache（线程安全 cache，参考 [`docs/developer/arch/text-rendering-spec.md`](../arch/arch_font.md)）。
...
| **S6 — 实验报告** | 产出 `docs/developer/reports/async_layout_report.md` 决定 Phase 2 是否默认开启 |
...
- [ ] `docs/roadmap.md` Phase 1 P1-8 状态 ✅；Phase 2 P2-9 标"由 P1-8 实验报告决定"
- [ ] `docs/developer/reports/async_layout_report.md` 入库
- [ ] `docs/developer/perf-budget.md` § 3.2 首屏阻塞实测填入
- [ ] `docs/reference/features-index.md` 新增 § "Async Layout / Shaping（实验）"
