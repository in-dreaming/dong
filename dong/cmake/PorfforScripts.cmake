...
set(DONG_PORFFOR_GENERATED_SOURCES
    "${DONG_PORFFOR_OUT_DIR}/registry.c"
    "${DONG_PORFFOR_OUT_DIR}/hello_dom.c"
    "${DONG_PORFFOR_OUT_DIR}/hello_dom__onBtnClick.c"
...
add_custom_command(
    ...
    DEPENDS
        ...
        "${CMAKE_SOURCE_DIR}/examples/porffor/hello_dom.js"
        "${CMAKE_SOURCE_DIR}/examples/porffor/handlers/hello_dom_onBtnClick.js"
        "${CMAKE_SOURCE_DIR}/examples/data/benchmarks/js_microbench_porffor.js"
...
function(dong_attach_porffor_scripts target_name)
    ...
    target_sources(${target_name} PRIVATE
        ${DONG_PORFFOR_GENERATED_SOURCES}
