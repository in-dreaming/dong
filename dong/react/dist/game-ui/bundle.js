(() => {
  ...
  // examples/game-ui/main.jsx
  var import_react = __toESM(require_react());

  // src/dong-react-renderer.js
  ...
  var hostConfig = {
    ...
    prepareUpdate(node, type, oldProps, newProps) {
      ...
      for (const key of allKeys) {
        if (key === "children") {
          ...
          if ((typeof o === "string" || typeof o === "number" || typeof n === "string" || typeof n === "number") && o !== n) {
            payload.push(key);
          }
          continue;
        }
    ...
    commitUpdate(node, payload, type, oldProps, newProps) {
      for (const key of payload) {
        if (!(key in newProps) || newProps[key] === void 0) {
          removeProp(node, key);
        } else {
  ...
  function HealthBar({ current, max, label }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginBottom: "8px" }, children: [
  ...
  function ScoreDisplay({ score, highScore }) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: "14px", color: "#95a5a6" }, children: "SCORE" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: "28px", fontWeight: "bold", color: "#ecf0f1" }, children: score.toLocaleString() }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: "11px", color: "#7f8c8d" }, children: [
        "HI: ",
  ...
  function InventorySlot({ item, index }) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
      ...
      item ? item.icon : "",
      item && item.count > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: {
        position: "absolute",
        bottom: "1px",
        right: "3px",
        fontSize: "10px",
  ...
  function Hotbar({ items }) {
    const slots = [];
    for (let i = 0; i < 8; i++) {
      slots.push(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(InventorySlot, { item: items[i] || null, index: i }, i));
    }
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", gap: "4px" }, children: slots });
  }
  function GameHUD() {
    const [hp, setHp] = (0, import_react.useState)(85);
    const [mp, setMp] = (0, import_react.useState)(60);
    const [score, setScore] = (0, import_react.useState)(12750);
    const items = [
      { icon: "\u2694", count: 1 },
    ...
    const takeDamage = (0, import_react.useCallback)(() => {
      setHp((h) => Math.max(0, h - 10));
    }, []);
    const heal = (0, import_react.useCallback)(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HealthBar, { current: hp, max: 100, label: "HP" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HealthBar, { current: mp, max: 100, label: "MP" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: "6px", marginTop: "8px" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: takeDamage, style: {
            padding: "4px 10px",
            fontSize: "11px",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: heal, style: {
            padding: "4px 10px",
            fontSize: "11px",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { position: "absolute", top: "15px", right: "15px" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScoreDisplay, { score, highScore: 5e4 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { position: "absolute", bottom: "15px", right: "15px" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Minimap, {}) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: {
        position: "absolute",
        bottom: "15px",
        left: "50%",
        marginLeft: "-208px"
      }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Hotbar, { items }) })
    ] });
  }
  render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GameHUD, {}), document.getElementById("root"));
})();
