...
void dong_porf_hello_dom__porf_init(void) {
  ...
  dong_porf_hello_dom_memory[97]=(u8)7;dong_porf_hello_dom_memory[101]=(u8)99;dong_porf_hello_dom_memory[102]=(u8)108;dong_porf_hello_dom_memory[103]=(u8)105;dong_porf_hello_dom_memory[104]=(u8)99;dong_porf_hello_dom_memory[105]=(u8)107;dong_porf_hello_dom_memory[106]=(u8)101;dong_porf_hello_dom_memory[107]=(u8)100;
}
...
static struct ReturnValue dong_porf_hello_dom_getElementById(f64 jjnewtarget, i32 jjnewtargetjjtype, f64 jjthis, i32 jjthisjjtype, f64 id, i32 idjjtype) {
  ...
  // if 
    if (((u32)(_get1)) != 0) {
      ...
      // if 
        if ((dong_porf_hello_dom__Porffor_object_isObject((i32)(_get2), _get3)) == 0) {
          _get4 = jjthis;
          _get5 = jjthisjjtype;
...
struct ReturnValue dong_porf_hello_dom_onBtnClick(f64 jjnewtarget, i32 jjnewtargetjjtype, f64 jjthis, i32 jjthisjjtype) {
  ...
  const struct ReturnValue _0 = dong_porf_hello_dom_setTextContent(0, 0, 0, 0, dong_porf_hello_dom_statusId, dong_porf_hello_dom_statusIdjjtype, 97, 195);
  (void) _0.type;
  (void) _0.value;
  _get0 = jjnewtarget;
  // if 
