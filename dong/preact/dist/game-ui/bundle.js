(() => {
  ...
  function z(n2, u4, t3, i4, r3, o3, e3, f4, c3, s3) {
    var a3, h3, p3, y3, _2, m3, b, S2, C3, M2, $2, I2, A2, H2, L, T3 = u4.type;
  ...
  function HealthBar({ current, max, label }) {
    ...
    return /* @__PURE__ */ u3("div", { style: { marginBottom: "8px" }, children: [
  ...
  function ScoreDisplay({ score, highScore }) {
    return /* @__PURE__ */ u3("div", { style: {
      ...
      /* @__PURE__ */ u3("div", { style: { fontSize: "14px", color: "#95a5a6" }, children: "SCORE" }),
      /* @__PURE__ */ u3("div", { style: { fontSize: "28px", fontWeight: "bold", color: "#ecf0f1" }, children: score.toLocaleString() }),
      /* @__PURE__ */ u3("div", { style: { fontSize: "11px", color: "#7f8c8d" }, children: [
        "HI: ",
  ...
  function InventorySlot({ item, index }) {
    return /* @__PURE__ */ u3("div", { style: {
      ...
      item ? item.icon : "",
      item && item.count > 1 && /* @__PURE__ */ u3("span", { style: {
        position: "absolute",
        bottom: "1px",
        right: "3px",
        fontSize: "10px",
  ...
  function Hotbar({ items }) {
    ...
    for (let i4 = 0; i4 < 8; i4++) {
      slots.push(/* @__PURE__ */ u3(InventorySlot, { item: items[i4] || null, index: i4 }, i4));
    }
    return /* @__PURE__ */ u3("div", { style: { display: "flex", gap: "4px" }, children: slots });
  }
  function GameHUD() {
    const [hp, setHp] = d2(85);
    const [mp, setMp] = d2(60);
    const [score, setScore] = d2(12750);
    const items = [
      { icon: "\u2694", count: 1 },
    ...
    y2(() => {
      const id = setInterval(() => {
        setScore((s3) => s3 + Math.floor(Math.random() * 10));
      }, 1e3);
      return () => clearInterval(id);
    }, []);
    const takeDamage = q2(() => {
      setHp((h3) => Math.max(0, h3 - 10));
    }, []);
    const heal = q2(() => {
      setHp((h3) => Math.min(100, h3 + 15));
    }, []);
    return /* @__PURE__ */ u3("div", { style: {
      width: "100%",
      height: "100%",
      ...
      /* @__PURE__ */ u3("div", { style: {
        ...
        /* @__PURE__ */ u3(HealthBar, { current: hp, max: 100, label: "HP" }),
        /* @__PURE__ */ u3(HealthBar, { current: mp, max: 100, label: "MP" }),
        /* @__PURE__ */ u3("div", { style: { display: "flex", gap: "6px", marginTop: "8px" }, children: [
          /* @__PURE__ */ u3("button", { onClick: takeDamage, style: {
            padding: "4px 10px",
            fontSize: "11px",
          ...
          /* @__PURE__ */ u3("button", { onClick: heal, style: {
            padding: "4px 10px",
            fontSize: "11px",
      ...
      /* @__PURE__ */ u3("div", { style: { position: "absolute", top: "15px", right: "15px" }, children: /* @__PURE__ */ u3(ScoreDisplay, { score, highScore: 5e4 }) }),
      /* @__PURE__ */ u3("div", { style: { position: "absolute", bottom: "15px", right: "15px" }, children: /* @__PURE__ */ u3(Minimap, {}) }),
      /* @__PURE__ */ u3("div", { style: {
        position: "absolute",
        bottom: "15px",
        left: "50%",
        marginLeft: "-208px"
      }, children: /* @__PURE__ */ u3(Hotbar, { items }) })
    ] });
  }
  J(/* @__PURE__ */ u3(GameHUD, {}), document.getElementById("root"));
})();
